...
.arcane-label.arcane-label--bold {
  font-weight: bold;
}
...
.arcane-nested-content.color-dark {
  background: var(--arcane-bg-dark-1);
}

.arcane-nested-content.color-lighter {
  background: var(--arcane-bg);
}

.arcane-nested-content.color-lighterer {
  background: var(--arcane-bg-light-1);
}
...
.arcane-timeline__data {
  display: flex;
}

.arcane-timeline__metadata {
  flex-grow: 1;
}

.arcane-timeline__source {
  display: flex;
  flex-direction: column;
  align-items: end;
  justify-content: center;
...
.arcane-timeline__indicator {
  font-size: 40px;
}

.arcane-timeline__bar {
  width: 100%;
  height: 10px;
  border: 1px solid var(--arcane-border-dark);
  background: var(--arcane-border-dark);
...
.arcane-timeline__fill {
  height: 100%;
  background: var(--arcane-hint);
}

.arcane-timeline__title {
  font-size: 1.5em;
  font-weight: bold;
  margin-bottom: 0.5em;
}

.arcane-timeline__subtitle {
  font-size: 1em;
  font-weight: bold;
  margin-bottom: 0.5em;
}
...
.arcane-slider-button.arcane-slider-button--grow {
  flex-grow: 1;
}

.arcane-slider-button > .arcane-slider-button__inner {
  position: absolute;
  display: flex;
  align-items: center;
  padding: 0 7.5px;
...
.arcane-slider-button > .arcane-slider-button__inner:hover {
  color: var(--arcane-text-normal);
  outline-color: rgba(243, 243, 245, 0.3);
  background: var(--arcane-gradient-button-hover);
  text-shadow: var(--arcane-shadow-text);
...
.arcane-slider-button.state-mouse-down > .arcane-slider-button__inner {
  color: var(--arcane-text-normal);
  outline-color: rgba(255, 255, 255, 0.3);
  background: var(--arcane-gradient-button-active);
  text-shadow: var(--arcane-shadow-text-active);
...
.arcane-slider-button > .arcane-slider-button__inner > input {
  color: var(--arcane-text-normal);
  opacity: 0;
  margin: 0 -9px;
  padding: 6px 8px;
...
.arcane-slider-button.state-focused > .arcane-slider-button__inner > input {
  opacity: 1;
  width: 60%;
  padding: 0 5px;
  margin: 0;
...
.arcane-slider-button__display-inner {
  height: 100%;
  background: var(--arcane-hint);
}

.arcane-slider-button__display.arcane-slider-button__display--gradient {
  height: 10px;
}
...
.arcane-slider-button__display.arcane-slider-button__display--gradient
  ...
  position: relative;
  background: none;
  border-right: 2px solid var(--arcane-border-dark);
}

.arcane-slider-button__display.arcane-slider-button__display--gradient
  > .arcane-slider-button__display-inner::before {
  content: '';
  position: absolute;
  width: 4px;
  top: -5px;
...
.arcane-slider-button__display.arcane-slider-button__display--gradient
  > .arcane-slider-button__display-inner::after {
  content: '';
  position: absolute;
  width: 2px;
  top: -4px;
  bottom: -4px;
  right: -2px;
  background: var(--arcane-text-normal);
}

.arcane-slider-button__value {
  width: 60px;
  margin: 0 -30px;
  line-height: 30px;
  text-align: center;
...
.arcane-slider-button.state-touching {
  z-index: 100;
}

.arcane-slider-button.state-touching .arcane-slider-button__inner {
  background: var(--arcane-bg-dark-1);
  width: 400px;
}

.arcane-slider-button.state-touching .arcane-slider-button__value {
  opacity: 1;
  margin: 0 7.5px;
}
`;
